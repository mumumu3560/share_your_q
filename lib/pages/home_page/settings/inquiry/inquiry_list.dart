                            ...
                            //RefreshIndicatorによってリロードできるようになる。
                              child: RefreshIndicator(
                                ...
                                child: ListView.builder(
                                  ...
                                  //TODO ここでリストの保持を行う。
                                  itemCount: widget.responseId != -1 ? commentList.length : commentList.length,
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    if(index == 0 && widget.responseId != -1){
                                      return Column(
                                        children: [
                                          CommentItem(item: widget.item!, isRes: true,),

                                          CommentItem(item: commentList[index], isRes: false,),
                                        ],
                                      );
                                    }
