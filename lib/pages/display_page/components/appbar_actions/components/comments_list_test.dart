                              ...
                              child: RefreshIndicator(
                                ...
                                child: ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    if(index == 0 && widget.responseId != -1){
                                      return CommentItem(item: widget.item!, isRes: true,);
                                    }
...
class _CommentItemState extends State<CommentItem> with AutomaticKeepAliveClientMixin {
  ...
  late Future<String> profileImageId;
  String userName = "";
  ...
  Future<String> fetchProfileImage(String target) async{
    ...
    try{
      ...
      if(response[0]["profile_image_id"] == null){
        setState(() {
          profileImageId = dotenv.get("CLOUDFLARE_NO_IMAGE_URL") as Future<String>;
        });
  ...
  void initState() {
    ...
    profileImageId = fetchProfileImage(targetUserId);
                        ...
                        Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (context) => ProfilePage(
                              userId: targetUserId, 
                              userName: userName, 
                              profileImage: profileImageId as String,
                            ),
                          ),
                        );
                      } else {
